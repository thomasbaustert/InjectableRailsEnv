...
We use a singleton instance variable here
TODO

  with_rails_env(JobsController, :production) do
    # set JobsController.rails_env = "production"
    get :index
    ...
  end
  # set JobsController.rails_env = nil
