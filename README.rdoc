...
When the code is execute by the Ruby interpreter <tt>rails_env</tt> has not been set
and there <tt>rails_env_production?</tt> will always return the value of <tt>Rails.env.production?</tt>.
